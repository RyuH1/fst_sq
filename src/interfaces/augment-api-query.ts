...
import type { Bytes, Option, U256, Vec, bool, u32, u64 } from '@polkadot/types-codec';
...
import type { AccountId, AccountIndex, Balance, BalanceOf, BlockNumber, H160, H256, Hash, KeyTypeId, Moment, Perbill, Percent, Releases, Slot, ValidatorId } from '@polkadot/types/interfaces/runtime';
...
import type { BridgeChainId, DepositNonce, ProposalVotes, ResourceId } from 'finitestate/interfaces/chainBridge';
import type { Chain, ChainIndex, DAOProposal, Project, ProjectId, ProposalId } from 'finitestate/interfaces/daoPortal';
...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    bridgeTransfer: {
      bridgeFee: AugmentedQuery<ApiType, (arg: BridgeChainId | AnyNumber | Uint8Array) => Observable<ITuple<[BalanceOf, u32]>>, [BridgeChainId]>;
    };
    chainBridge: {
      chainNonces: AugmentedQuery<ApiType, (arg: BridgeChainId | AnyNumber | Uint8Array) => Observable<Option<DepositNonce>>, [BridgeChainId]>;
      ...
      votes: AugmentedQuery<ApiType, (arg1: BridgeChainId | AnyNumber | Uint8Array, arg2: ITuple<[DepositNonce, Proposal]> | [DepositNonce | AnyNumber | Uint8Array, Proposal | { callIndex?: any; args?: any } | string | Uint8Array]) => Observable<Option<ProposalVotes>>, [BridgeChainId, ITuple<[DepositNonce, Proposal]>]>;
    };
    council: {
      /**
    ...
    daoPortal: {
      chains: AugmentedQuery<ApiType, (arg: ChainIndex | AnyNumber | Uint8Array) => Observable<Option<Chain>>, [ChainIndex]>;
      latestChainIndex: AugmentedQuery<ApiType, () => Observable<ChainIndex>, []>;
      latestProjectId: AugmentedQuery<ApiType, () => Observable<ProjectId>, []>;
      latestProposalId: AugmentedQuery<ApiType, (arg: ProjectId | AnyNumber | Uint8Array) => Observable<ProposalId>, [ProjectId]>;
      projects: AugmentedQuery<ApiType, (arg: ProjectId | AnyNumber | Uint8Array) => Observable<Option<Project>>, [ProjectId]>;
      proposals: AugmentedQuery<ApiType, (arg1: ProjectId | AnyNumber | Uint8Array, arg2: ProposalId | AnyNumber | Uint8Array) => Observable<Option<DAOProposal>>, [ProjectId, ProposalId]>;
      relayer: AugmentedQuery<ApiType, () => Observable<AccountId>, []>;
      voteFee: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []>;
    };
    democracy: {
      /**
    ...
    game: {
      attackCount: AugmentedQuery<ApiType, () => Observable<u32>, []>;
    };
    grandpa: {
      /**
    ...
    staking: {
       ...
       **/
      minNominatorBond: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []>;
      /**
       * The minimum active bond to become and maintain the role of a validator.
       **/
      minValidatorBond: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []>;
      /**
