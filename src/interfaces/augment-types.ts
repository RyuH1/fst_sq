...
import type { BridgeChainId, BridgeTokenId, DepositNonce, ProposalStatus, ProposalVotes, ResourceId } from 'finitestate/interfaces/chainBridge';
import type { Chain, ChainIndex, CrossChainAccount, DAOProposal, DAOProposalState, DAOProposalStatus, IpfsHash, OptionIndex, PrivacyLevel, Project, ProjectId, ProposalId, Protocol, SolidityStrategy, Strategy, SubstrateStrategy, VoteUpdate, VotingFormat, VotingPower, Workspace } from 'finitestate/interfaces/daoPortal';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    SolidityStrategy: SolidityStrategy;
    ...
    SubstrateStrategy: SubstrateStrategy;
    Supports: Supports;
    SyncState: SyncState;
